...
namespace PR_Lab3_Sample
{
     public partial class Form1 : Form
     {
          ...
          private void crawlerBtn_Click(object sender, EventArgs e)
          {
               try
               {
                    crawlerBtn.Enabled = false;
                    crawlerRichTextBox.Text = "";
          ...
          private  async void PostRequest(string url)
          {
               ...
               {
                    new KeyValuePair<string, string>("FirstPost", "Tudor"),
                    new KeyValuePair<string, string>("SecondPost", "Turcan")
               };
